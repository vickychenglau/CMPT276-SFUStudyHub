...
class TopicTest < ActiveSupport::TestCase
  ...
  test "Test if post is valid" do
    ...
    user = users(:david)
    topic = Topic.new(:course_id => 1, :user_id => 1 ,:description => "First year physics", :description => "I need a tutor", :title => "Physics 101 help")
  ...
  test "Has no user attached to the Topic" do
    ...
    topic = Topic.new(:course_id => 1, :description => "First year physics", :title => "Physics 101 help")
